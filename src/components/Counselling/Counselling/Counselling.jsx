...
const Counselling = () => {
  ...
  return (
    <div className="w-full bg-[#0D1117]">
      ...
      <div className="px-8 md:px-20 py-6 border-b-4 border-slate-800">
        <div>
      ...
      <div className="px-8 md:px-20 py-20 border-b-4 border-slate-800">
        <h1 className="text-[#D0DFFF]">Our Services</h1>
        <div>
          <div
            data-aos="fade-up"
      ...
      <div className="px-8 md:px-20 py-20 border-b-4 border-slate-800">
        <h1 className="text-[#D0DFFF]">Why Choose Us</h1>
        <div>
          <div
            data-aos="fade-up"
            data-aos-duration="1000"
      ...
      <div className="flex flex-col justify-evenly items-center md:flex-row p-20 ">
        <div>
          <iframe
            data-aos="fade-right"
            className="rounded-xl hover: shadow-hover"
            loading="lazy"
        ...
        <div>
          <h1 className="text-[#D0DFFF]">Sign Up to our E-Newsletter</h1>
          <form action="" className="py-4">
            <div className="flex justify-between items-center py-2">
              ...
              <input
                className="px-4 py-3 rounded-lg text-2xl"
                type="text"
